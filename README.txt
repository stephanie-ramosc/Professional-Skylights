...
home.php
Muestra la pagina principal con las opciones a ver y datos de la compania.

Empleados.php
Muestra la lista de todos los empleados en la base de datos.

AddEmpleado.php
Muestra los campos requeridos para guardar la informacion de los empleados, luego envia los datos a otro enlace.
